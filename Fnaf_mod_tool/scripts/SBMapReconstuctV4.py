...
# === Create or Load Map ===
def create_new_map(level_name="AutoMapFromJSON", save_path="/Game/Maps/RecreatedMaps"):
    full_asset_path = f"{save_path}/{level_name}"
...
# === Create or Load New Map ===
created_map = create_new_map()
if not created_map:
